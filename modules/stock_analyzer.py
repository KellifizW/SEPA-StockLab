...
from modules.rs_ranking import get_rs_rank, get_rs_rank_lightweight, RS_NOT_RANKED
...
def analyze(ticker: str,
    ...
    rs_rank = get_rs_rank_lightweight(ticker)  # avoids full universe rebuild for single-stock analysis
